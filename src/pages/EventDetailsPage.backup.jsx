...
// Create a generic event object for fallback
const createGenericEvent = (eventId) => ({
  ...
  country: 'Country',
  category: 'General',
  image: 'https://via.placeholder.com/800x450?text=Event+Image',
  capacity: 100,
  registered: 0,
  price: 0,
  currency: 'INR',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-[60vh] w-full overflow-hidden">
        <img
          src={event.image || sampleEventData.image}
          alt={event.title}
          className="w-full h-full object-cover"
          onError={(e) => (e.target.src = sampleEventData.image)}
        />
