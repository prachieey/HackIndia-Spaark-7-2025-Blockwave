        ...
        <div className="relative w-full max-w-md">
          ...
          <div className="relative bg-space-black/80 border-2 border-deep-purple rounded-2xl p-6 shadow-xl">
            ...
            <div className="mt-12 space-y-4">
              <div key="secure-tickets" className="flex items-center space-x-4 group cursor-pointer hover:bg-gray-800/50 p-3 rounded-lg transition-colors">
              ...
              <div key="qr-tech" className="flex items-center space-x-4 group cursor-pointer hover:bg-gray-800/50 p-3 rounded-lg transition-colors">
              ...
              <div key="how-it-works" className="flex items-center space-x-4 group cursor-pointer hover:bg-gray-800/50 p-3 rounded-lg transition-colors"
